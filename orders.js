...
class Ticket{
    ...
    constructor(items,orderTime,customerId){
        console.log(`Food ordered : ${this.items = items}`),
        console.log(`At the Time : ${this.orderTime = orderTime}`),
        console.log(`Customer ID : ${this.customerId = customerId}`)
    ...
    updateStatus(newStatus)
    {
        ...
        console.log(`Order for customer: ${this.customerId} is ${this.status}`)
    }
...
let firstTicket  = new Ticket("Pizza, Soda","12:45 am", 333)

firstTicket.updateStatus("Coocking")
firstTicket.test()
